...
public class OllamaProfileLlmClient implements ProfileLlmClient {

    private final RestClient ollamaRestClient;
    private final String model;
    private final JsonParser jsonParser = JsonParserFactory.getJsonParser();

    public OllamaProfileLlmClient(RestClient ollamaRestClient, String model) {
    ...
    public String generateProfileJson(String systemPrompt, String userPrompt) {
        ...
        try {
            ...
            throw new LlmClientException("Ollama profile request failed: " + summarize(ex), ex);
        }
    }
